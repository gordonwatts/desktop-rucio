...
from tests.grid.utils_for_tests import dummy_status
...
def test_download_status(rucio_good_ds_download_takes_time):
    ...
    res_future = tp.submit(rucio.download_files, r, "mc16_13TeV.311309.MadGraphPythia8EvtGen_A14NNPDF31LO_HSS_LLP_mH125_mS5_ltlow.deriv.DAOD_EXOT15.e7270_e5984_s3234_r10201_r10210_p3795dude", '/data')
